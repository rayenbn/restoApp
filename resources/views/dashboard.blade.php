...
<!-- Your Page Content Here -->
    ...
    <div class="row">
		<div class="col-md-3 col-sm-6 col-xs-12">
			<div class="info-box">
				...
				<div class="info-box-content">
				  <span class="info-box-text">Orders Open</span>
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			 <div class="info-box">
				<!-- Apply any bg-* class to to the icon to color it -->
				<span class="info-box-icon bg-orange-active"><i class="fa fa-star-o"></i></span>
				<div class="info-box-content">
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
			  <div class="info-box">
				...
				<div class="info-box-content">
				  <span class="info-box-text">Complited</span>
				  <span class="info-box-number">93,139</span>
				</div><!-- /.info-box-content -->
			  </div><!-- /.info-box -->
		</div>
    ...
    <div class="col-md-4">
        <div class="box box-primary">
            ...
            <div class="box-footer text-center">
              <a href="javascript:void(0)" class="btn btn-sm btn-info btn-sm">Confirm Order</a>
            </div>
            <!-- /.box-footer -->
        </div>
      </div>
